...
function SvgIconSchool() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M2 10L12 4L22 10L12 16L2 10Z" stroke="#f55d1b" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
      ...
      <path d="M22 10V16" stroke="#f55d1b" strokeWidth="1.75" strokeLinecap="round"/>
    </svg>
  );
}
...
function SvgIconCampus() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M3 11H21" stroke="#f55d1b" strokeWidth="1.5" strokeDasharray="2 2"/>
      <path d="M8 15V17M12 15V17M16 15V17" stroke="#f55d1b" strokeWidth="1.75" strokeLinecap="round"/>
      <path d="M12 2L15 6H9L12 2Z" fill="#f55d1b" fillOpacity="0.3" stroke="#f55d1b" strokeWidth="1.5"/>
    </svg>
  );
}
...
function SvgIconFreightCorridor() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M6.5 15H17.5M7.8 11.5H16.2M9.2 8H14.8" stroke="#f55d1b" strokeWidth="1.75" strokeLinecap="round"/>
      <circle cx="12" cy="17" r="1.5" fill="#f55d1b"/>
    </svg>
  );
}
...
function SvgIconAggregate() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <polygon points="12,3 20,8 17,19 7,19 4,8" stroke="#f55d1b" strokeWidth="1.5" fill="#f55d1b" fillOpacity="0.15"/>
...
function SvgIconIndustrial() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M16 7H18M16 11H18M16 15H18" stroke="#f55d1b" strokeWidth="1.75" strokeLinecap="round"/>
    </svg>
  );
}
...
function SvgIconVilla() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M2 11L12 4L22 11" stroke="#f55d1b" strokeWidth="1.75" strokeLinecap="round"/>
      <path d="M4 11V20H20V11" stroke="#ffffff" strokeWidth="1.5"/>
      <rect x="9" y="13" width="6" height="7" stroke="#f55d1b" strokeWidth="1.5" fill="#f55d1b" fillOpacity="0.2"/>
    </svg>
  );
}
...
function SvgIconPin() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="inline-block mr-1 text-[#f55d1b]">
      <path d="M12 21C16 17 20 13.4183 20 9C20 4.58172 16.4183 1 12 1C7.58172 1 4 4.58172 4 9C4 13.4183 8 17 12 21Z" stroke="#f55d1b" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <circle cx="12" cy="9" r="3" fill="#f55d1b"/>
    </svg>
  );
}
...
function SvgActionArrow() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="project-action-arrow">
      <circle cx="12" cy="12" r="10" stroke="#f55d1b" strokeWidth="1.5" strokeDasharray="3 3"/>
      <path d="M9 12H15M15 12L12 9M15 12L12 15" stroke="#f55d1b" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
    ...
    <section className="featured-projects-section" ref={sectionRef} id="portfolio">
      ...
      <div className="projects-container">
        ...
        <div className="projects-header">
          <div className=" flex space-x-2 items-center text-[#f55d1b]">
            <span className="">•</span> 
            ...
            return (
              ...
              >
                ...
                <div className="project-col-num flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-[#000435] border border-white/10 flex items-center justify-center shadow-md group-hover:border-[#f55d1b]/50 group-hover:bg-[#f55d1b]/10 transition-all duration-300">
                    <ProjectIcon />
                  </div>
                ...
                <div className="project-col-title">
                  <span className="font-mono text-[10px] text-[#f55d1b] tracking-widest uppercase font-bold block mb-1">
                    {project.tag}
                  </span>
                ...
                <div className="project-col-action">
                  <span className="project-action-btn group-hover:text-[#f55d1b] transition-colors">
