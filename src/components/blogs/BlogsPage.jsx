...
export default function BlogsPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#000435] via-[#4e71d2] to-[#434885] text-white font-primary relative overflow-x-hidden selection:bg-[#f55d1b] selection:text-white">
      ...
      <section className="relative z-10 pt-28 sm:pt-36 min-h-screen lg:pt-40 pb-8 sm:pb-24 border-b border-sky-400/20 overflow-hidden min-h-[540px] sm:min-h-[520px] lg:min-h-[580px] flex items-end sm:items-center">
      ...
      <section className="relative z-10 py-6 lg:py-8">
        <div className="max-w-7xl 2xl:max-w-[1580px] mx-auto px-4 sm:px-8 lg:px-12 space-y-8 sm:space-y-14">
          {BLOG_POSTS.map((post, idx) => {
            ...
            return (
              <article
                key={post.id}
                id={post.id}
                className="scroll-mt-28 rounded-2xl p-4 sm:p-8 lg:p-10 bg-gradient-to-br from-[#0a2360]/35 via-[#061845]/50 to-[#020b24]/70 backdrop-blur-2xl relative overflow-hidden transition-all duration-300 hover:border-[#f55d1b]/60"
              >
                <CornerCrosshairs />
